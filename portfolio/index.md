...
{% assign public_counter = 0 %}{% for project in site.data.git.public-featured %}{% if project.visibility == "public" %}{% assign public_counter=public_counter | plus:1 %}{% endif %}{% endfor %}
